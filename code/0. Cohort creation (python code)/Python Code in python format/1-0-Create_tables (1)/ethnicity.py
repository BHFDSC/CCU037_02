...
# MAGIC  
# MAGIC **Data input**   
# MAGIC * gdppr_data =  `.ccu037_gdppr_primary_and_snomed_fa` 
# MAGIC * hes_data = `.hes_apc_all_years`  
# MAGIC     
# MAGIC **Data output**  
# MAGIC * `.ccu037_ethnicity` 1 row per patient
# MAGIC 
...
gdppr_data = ".gdppr_dars_nic_391419"
hes_data = ".hes_apc_all_years_archive"
...
# MAGIC %sql
# MAGIC SELECT * FROM .gdppr__archive

# COMMAND ----------

gdppr_prod_date = SELECT max(distinct ProductionDate) FROM .gdppr__archive
...
# MAGIC %sql
# MAGIC SELECT DISTINCT(ProductionDate) FROM .hes_apc_all_years_archive
...
spark.sql(f"""
 ...
 SELECT DISTINCT PERSON_ID_DEID as NHS_NUMBER_DEID, 
      ...
      "hes_apc" as dataset,
      3 as eth_rank
  FROM .hes_apc_all_years_archive 
...
# MAGIC %sql
# MAGIC SELECT * FROM .ccu037_ethnicity_all_codes
