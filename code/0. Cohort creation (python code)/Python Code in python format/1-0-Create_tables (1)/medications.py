...
# MAGIC %sql
# MAGIC SELECT * FROM .primary_care_meds_
...
# MAGIC SELECT * FROM .primary_care_meds_ WHERE Person_ID_DEID IS NOT NULL
...
# MAGIC SELECT * 
# MAGIC FROM
# MAGIC .primary_care_meds_ WHERE Person_ID_DEID IS NOT NULL
...
# MAGIC SELECT * 
# MAGIC FROM .primary_care_meds_ WHERE Person_ID_DEID IS NOT NULL
