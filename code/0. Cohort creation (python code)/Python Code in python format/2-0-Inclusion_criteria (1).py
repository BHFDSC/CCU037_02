...
# MAGIC * covid_data = `.ccu037_covid_events`
# MAGIC     
# MAGIC **Data output**  
...
SELECT *, *, *
FROM ((.ccu037_ethnicity_assembled_multiple_granularities as ethnicity
INNER JOIN .ccu037_demographics as demographics ON ethnicity.NHS_NUMBER_DEID = demographics.person_id_deid)
LEFT JOIN .ccu037_covid_events as covid_events ON ethnicity.NHS_NUMBER_DEID = covid_events.person_id_deid) """)
