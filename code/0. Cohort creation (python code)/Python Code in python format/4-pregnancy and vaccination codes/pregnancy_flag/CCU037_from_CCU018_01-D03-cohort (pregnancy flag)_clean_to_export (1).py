...
# MAGIC %run "/Workspaces//CCU037_01/Pregnancy_flag_parameters/CCU018_01-D01-parameters (pregnancy flag)"
...
# MAGIC %run /Workspaces//CCU037_01/Pregnancy_flag_parameters/CCU018_01-D03a-cohort_deliveries_clean (pregnancy flag)
...
#cohort = spark.table(".ccu037_02_cohort")
cohort02 = spark.table(".ccu037_follow_up_availability")
preg = spark.table(".ccu037_02_tmp_cohort")
