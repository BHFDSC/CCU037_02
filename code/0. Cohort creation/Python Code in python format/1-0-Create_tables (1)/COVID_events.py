...
# MAGIC  
# MAGIC **Data input**  
# MAGIC * `.ccu037_covid_trajectory` Specified in cell 4 below  
# MAGIC 
# MAGIC **Data output**  
# MAGIC * `.ccu037_covid_events` 1 row per patient
# MAGIC 
...
spark.sql(f"OPTIMIZE .ccu037_covid_events ZORDER BY person_id_deid")
