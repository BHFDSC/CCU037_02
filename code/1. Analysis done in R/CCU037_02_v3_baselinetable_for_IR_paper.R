...
write.table (tab6Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/baselinetable_6gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
...
write.table (tab9Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/baselinetable_9gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
...
write.table (tab19Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/baselinetable_18gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
