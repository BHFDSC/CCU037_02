...
#Add pregnancy flag:
mydata2<- dbGetQuery(con,"SELECT NHS_NUMBER_DEID,preg_flag FROM .ccu037_02_pregnancy_flag") #
...
mydata3<- dbGetQuery(con,"SELECT * FROM .ccu037_02_vaccination_gdppr_men") 
...
write.table (tab6Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/menbaselinetable_6gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
...
#write.table (tab9Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/menbaselinetable_9gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
...
write.table (tab19Mat , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/menbaselinetable_18gr_tableone_MPM.csv", col.names = T, row.names=T, append= F, sep=',')
...
#GO To "/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/Clean R codes" for coding to export save tables (i.e., applying round rules...) 
...
#Add snomed meaning:
snomed_meaning <- dbGetQuery(con,"SELECT * FROM .ccu037_snomed_conceptid_description")
...
View(df)
#write.table (df , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/ccu037_02_men_aggregated_diversity.csv", col.names = T, row.names=T, append= F, sep=',')
...
#write.table (tSplit[,c(7:13)] , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/ccu037_02_frequency_6highlvl_over_months.csv", col.names = T, row.names=T, append= F, sep=',')
...
View(df)
#write.table (df , "~//CCU037/CCU037_02/Results/baseline_tables_IR_manuscript/ccu037_02_men_aggregated_diversity_permonths.csv", col.names = T, row.names=T, append= F, sep=',')
