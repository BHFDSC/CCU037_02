...
mydata <- readRDS("/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/CCU037_02_cohort.rds")
...
if (run_save_tables == "YES"){
  if (years_restriction == "20-21") {path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/IR_2020_2021_subset/IR_eth&age&sex_censored.csv"} else {
    path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/IR_eth&age&sex_censored.csv"}
  for (i in 1:length(IR_list)){
  ...
  if (years_restriction == "20-21") {path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/IR_2020_2021_subset/IR_eth&age&sex&months_censored.csv"} else{
    path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/IR_eth&age&sex&months_censored.csv"}
  for (i in 1:length(IR12_list)){
...
# folder_path = "/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/Results/IR_by_eth_age_sex_period_censored/"
...
if(save_plots == "YES"){
  ...
  folder_path = "/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/Results/IR_by_time_6months_censored/Individual plots ie., only 6, 9 or 18 cat/"
...
# filename1 = paste("/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/QRISk3_all_models_AND_calibration_plots_by_age_&_age_ethnicity", ".rds", sep="")
...
run_save_tables = "NO" #Options "NO"/"YES" (default "NO" to avoid append overwriting)
if (run_save_tables == "YES"){
  path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/age_std_IR_correct_CI_censored.csv"
  for (i in 1:length(IR_list_censored)){
  ...
  path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/age_std_IR_correct_CI_byperiod_IR12_censored.csv"
  for (i in 1:length(IR12_list_censored)){
...
if (run_save_tables == "YES"){
  path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/age_std_IR_correct_CI_byyears_IR1_censored.csv"
  for (i in 1:3){
    if (i == 1){write.table(IR12_list_censored[[i]],  path_filename, col.names = T, row.names=F, append= T, sep=',')}
    else {write.table(IR12_list_censored[[i]],  path_filename, col.names = F, row.names=F, append= T, sep=',')}
  }
  
  path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/age_std_IR_correct_CI_every6months_IR2_censored_Part1_6&9cat.csv"
  for (i in 4:5){
    if (i == 4){write.table(IR12_list_censored[[i]],  path_filename, col.names = T, row.names=F, append= T, sep=',')}
    else {write.table(IR12_list_censored[[i]],  path_filename, col.names = F, row.names=F, append= T, sep=',')}
  }
  path_filename = "~//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/age_std_IR_correct_CI_every6months_IR2_censored_Part2_19cat.csv"
...
if(save_plots == "YES"){
  folder_path = "/mnt/efs/marta.pinedamoncusi//CCU037/CCU037_02/Results/IR_by_time_6months_censored/age-std IR - Plots and censored tables/combined age-std IR plots 6cat vs10 or 19/"
