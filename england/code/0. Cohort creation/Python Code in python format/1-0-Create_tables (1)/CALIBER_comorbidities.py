...
# Table names
demographics_table = ".ccu037_cohort_base_over18_posi_test"
phenotypes_table = ".ccu037_caliber"
...
# MAGIC %sql
# MAGIC SELECT * FROM .gdppr__archive WHERE ProductionDate = "2022-06-29 00:00:00.000000"

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT COUNT(DISTINCT NHS_NUMBER_DEID) FROM .gdppr__archive WHERE ProductionDate = "2022-06-29 00:00:00.000000"
...
demographics_table = ".ccu037_cohort_all_inclusion_criteria"

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM .ccu037_cohort_all_inclusion_criteria
