...
# MAGIC %sql
# MAGIC SELECT MAX(ProductionDate) FROM .hes_apc_all_years_archive
...
# MAGIC %sql
# MAGIC SELECT MAX(ProductionDate) FROM .gdppr__archive
...
# MAGIC %sql
# MAGIC SELECT DISTINCT phenotype FROM .ccu037_caliber
