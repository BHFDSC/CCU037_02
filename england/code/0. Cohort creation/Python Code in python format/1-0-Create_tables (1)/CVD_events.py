...
# MAGIC %sql
# MAGIC select count(distinct person_id_deid) from dars_nic_391419_j3w9t_collab.ccu037_caliber 
...
CREATE OR REPLACE GLOBAL TEMP VIEW ccu037_post_covid_cvd_events_list AS
    ...
    LEFT JOIN dars_nic_391419_j3w9t_collab.ccu037_inclusion_criteria_updated as b
...
FROM dars_nic_391419_j3w9t_collab.ccu037_inclusion_criteria_updated a
...
# MAGIC LEFT JOIN dars_nic_391419_j3w9t_collab.ccu037_inclusion_criteria_updated as b
