...
# MAGIC %sql
# MAGIC SELECT * FROM .ccu037_cvd_outcomes_and_dates
...
FROM .ccu037_cvd_outcomes_with_dates a
...
# MAGIC %sql
# MAGIC select count(*) from .ccu037_follow_up_availability where covid_date > to_date(reg_date_of_death, "yyyyMMdd")

# COMMAND ----------

# MAGIC %sql
# MAGIC select count(*) from .ccu037_follow_up_availability